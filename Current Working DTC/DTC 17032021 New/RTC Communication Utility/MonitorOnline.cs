    ...
    public partial class MonitorOnline : Form
    {
                                                                                ...
                                                                                if (val.Count == 8)
                                                                                {
                                                                                    ...
                                                                                    try
                                                                                    {
                                                                                        ...
                                                                                        if (Writedatab != true)
                                                                                        {
                                                                                            ...
                                                                                            lblSwVersion.Invoke((Action)(() => lblSwVersion.Text = String.Format("{0:0.00}", ver.ToString(CultureInfo.InvariantCulture))));
        ...
        private DataTable CreateDynamicDataTable()
        {
            try
            {
                ...
                newRow["Decription"] = "Process value(PV)";
                stdTable.Rows.Add(newRow);
                newRow = stdTable.NewRow();
                ...
                newRow["Decription"] = "PB : Proportional band";
                stdTable.Rows.Add(newRow);
                newRow = stdTable.NewRow();
